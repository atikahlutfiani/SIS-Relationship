...
<head>
  ...
  <title>Apk Perdagangan</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="{{asset('frontend/assets/img/hero-img.png')}}" rel="icon">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="screens-slider swiper">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="{{asset('frontend/assets/img/screen/1.jpg')}}" class="img-fluid" alt=""></div>
